...
\begin{definicija}
Naj bo $T$ nek objekt v kategoriji $\cat{C}$, Pravimo mu \textit{testni objekt}. Naj bo $A$ poljuben objekt v $\cat{C}$. \textit{Posplošeni element} je morfizem $t:T \to A$ iz testnega objekta v A.
\end{definicija}
