...
Definirajmo $u : Z \to P$ kot $u(z) = (z_1(z), z_2(z))$
...
\begin{primer}
Poglejmo kako ta abstraktna karakterizacija limit ustreza znanemu pojmu limite v analizi. Limita zaporedja na primer realnih števia $(a_n)_{n \in \mathbb{N}}$ je tako realno število $L \in \mathbb{R}$, da za vsak $\epsilon > 0$ obstaja tak $n_0 \in \mathbb{N}$ , da za vsak $n \geq n_n : \abs{a_n - L} < \epsilon$. (Za ta primer nam manjka definicija filtra v topološkem prostoru za to pa nam manjka definicija topološke mreže
\end{primer}
